...
/// ProfileScreen - Capa de Presentación
/// 
/// Permite visualizar y editar la información del usuario, además de 
/// centralizar accesos a pedidos, favoritos y soporte.
...
class _ProfileScreenState extends State<ProfileScreen> {
  /// Inyección de controladores de infraestructura/estado
  ...
  void initState() {
    super.initState();
    /// Carga inicial de datos desde el estado global del dominio de Usuario
  ...
  void _saveProfile() {
    /// Envío de datos a la capa de infraestructura para persistencia
    authController.updateUserInfo(_nameController.text, _phoneController.text);
    setState(() {
      _isEditing = false;
    });
    Get.snackbar(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            /// Obx permite reaccionar a cambios en el usuario (ej. tras una edición)
            Obx(() {
              final user = authController.currentUser;
              return Container(
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  /// Ejemplo de navegación reactiva: En lugar de navegar a una nueva pantalla,
                  /// se cambia el índice del IndexedStack en el Home.
                  ProfileMenuTile(
                    icon: Icons.shopping_bag_outlined,
                    title: 'Mis Pedidos',
                    subtitle: 'Ver historial y estado de tus compras',
                    onTap: () => productController.setHomeTabIndex(3),
                  ),
                  ProfileMenuTile(
                    icon: Icons.favorite_outline,
                    title: 'Mis Favoritos',
                    subtitle: 'Productos que te han encantado',
                    onTap: () => productController.setHomeTabIndex(1),
                  ),
                  ProfileMenuTile(
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          const Divider(height: 30),
          _buildEditableField('Email', _emailController, Icons.email_outlined, false),
        ],
      ),
    );
  }
