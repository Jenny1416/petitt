...
/// AddressesScreen - Capa de Presentación
/// 
/// Gestiona la libreta de direcciones del usuario. 
/// Utiliza el [OrderController] para persistir y recuperar las direcciones
/// siguiendo el flujo de la arquitectura hexagonal.
...
class _AddressesScreenState extends State<AddressesScreen> {
  /// Controladores locales para el manejo de formularios (UI State)
  final TextEditingController _titleController = TextEditingController();
  final TextEditingController _addressController = TextEditingController();
  
  /// Inyección del controlador de pedidos para acceder al estado global de direcciones
            ...
            PrimaryButton(
              ...
              onTap: () {
                if (_titleController.text.isNotEmpty && _addressController.text.isNotEmpty) {
                  /// Comunicación con la capa de infraestructura para persistir la nueva dirección
                  orderController.addAddress(_titleController.text, _addressController.text);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      /// Reacción automática ante cambios en la lista de direcciones (Reactividad GetX)
      body: Obx(() {
          ...
          itemBuilder: (context, i) {
            ...
            return Container(
              ...
              child: ListTile(
                ...
                onTap: () => orderController.setPrimaryAddress(i),
                leading: Container(
                  padding: const EdgeInsets.all(12),
                  decoration: BoxDecoration(
                    color: isPrimary ? const Color(0xff123516) : const Color(0xff123516).withValues(alpha: 0.05),
                ...
                trailing: IconButton(
                  ...
                  onPressed: () => orderController.removeAddress(i),
                ),
              ),
            );
          },
