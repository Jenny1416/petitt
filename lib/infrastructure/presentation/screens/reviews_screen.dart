...
class ReviewsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Product initialProduct = product ?? Get.arguments as Product;
    ...
    return Scaffold(
      ...
      body: Obx(() {
        final currentProduct = productController.products.firstWhere(
        ...
        return SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              ...currentProduct.reviews.reversed.map((r) => _buildReviewItem(r, productController)),
          ],
        ),
      );
      }),
  ...
  Widget _buildReviewItem(ReviewModel review, ProductController controller) {
    return Container(
        ...
        children: [
          ...
          Row(
            children: [
              ...
              InkWell(
                onTap: () {
                  // TODO: Implement toggleReviewLike in ProductController
                },
                child: Row(
                  children: [
                    Icon(
